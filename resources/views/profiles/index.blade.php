...
<div class="container">
    <div class="row ">
        <div class="col-3 p-5">
            ...
            alt="" class="rounded-circle" style="height:185px">
        </div> 
        <div class="col-9 pt-5">
            <div class="d-flex justify-content-between align-items-baseline">
                <h1>{{ $user->username }}</h1>
                <btn href="#" class="btn btn-primary btn-sm ">Add New Post</btn>
            </div>
    ...
    <div class="row pt-4">
            <div class="col-4">
                <img src="https://hanoicomputercdn.com/media/product/70065_may_choi_game_cam_tay_steam_deck_512gb_0002_3.jpg"
                alt="" class="w-100 h-100 pe-2" style="">
            </div>
            <div class="col-4">
                <img src="https://media-api-beta.thinkpro.vn/media/core/products/2022/10/3/lenovo-legion-slim-7i-thinkpro-1.jpg"
                alt="" class="w-100 h-100 pe-2" style="">
            </div>
            <div class="col-4">
                <img src="https://hanoicomputercdn.com/media/product/70065_may_choi_game_cam_tay_steam_deck_512gb_0002_3.jpg"
