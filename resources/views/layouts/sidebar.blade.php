<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse ">
    <div class="position-sticky">
        ...
        @guest
            ...
            @endif
        @else
            <a id="link" href="/" class="home nav-link" aria-current="true">
                <div class="items">
            ...
            <a href="/explore" class="nav-link">
                <div class="items">
                    <img src="{{ asset('icons/direction.png') }}" class="me-3"><span class="">Explore</span>
                </div>
            </a>
            ...
            <div id="notificationSidebar" class="sidebarNoti" style="display: none">
                @include('notifications.index')
            </div>
            <a class="" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" aria-expanded="false"
